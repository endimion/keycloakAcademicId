 ...
 * @author nikos
 */
public class BeforeAcIDAuthenticator extends AbstractAcIDAuthenticator {
...
//
//            String resourceUrl = uportHelperMsHost + "/connectionRequest?eidas=true&ssiSessionId=" + sessionId + "&callback=" + callback;
